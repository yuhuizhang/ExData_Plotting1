...
par(mfcol = c(2, 2))
with(myData, plot(TimeFormat, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
...
legend("topright", col = c("black", "red",  "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), pch = '-', lty = 1, bty = "n")

with(myData, plot(TimeFormat, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))

with(myData, plot(TimeFormat, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
